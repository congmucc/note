...
[安装elasticsearch和分词器](./安装elasticsearch/安装elasticsearch.md)
...
> 这里注解`@BeforeEach`和`@AfterEach`可以看[JUnit5](../../框架/SpringBoot/JUnit5/JUnit5.md)
> 这个一个是测试前运行，一个是测试后删除
...
> 2中转换为文档类型是因为我们将经纬度的两个参数转换为了文档中的location属性
>
> 主要转化为json对象，这里需要我们转换
