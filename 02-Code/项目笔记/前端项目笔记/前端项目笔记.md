...
> 该数据大屏参考[Geeker Admin]([Geeker-Admin: ✨✨✨ Geeker Admin，基于 Vue3.4、TypeScript、Vite5、Pinia、Element-Plus 开源的一套后台管理框架。 (gitee.com)](https://gitee.com/HalseySpicy/Geeker-Admin))
## 一、vue3组件通信方式
