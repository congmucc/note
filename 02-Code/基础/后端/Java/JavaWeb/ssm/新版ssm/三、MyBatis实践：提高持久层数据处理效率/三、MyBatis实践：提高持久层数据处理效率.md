...
![](image_Sd6pCEE6Oi.png)

#### 2.1.3 **\${}形式**

\${}形式传参，底层Mybatis做的是字符串拼接操作。

![](image_KYrG3XT73t.png)
...
-   Mapper 配置文件放在 Mapper 接口所在的包内
    ...
    -   可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件
        ...
        ![](image_ehqr6FrNXV.png)

        ![](image_PhqgFRgNDi.png)
